export const i18n = {
  ...
  nav: {
    links: [
      ...
      { label: 'Il mio percorso', href: '#timeline' },
  ...
  timeline: {
    ...
    description: 'Dal liceo all\'architettura enterprise — il mio percorso formativo e professionale.',
    badgeWork: 'Lavoro',
    badgeEducation: 'Formazione',
    items: [
      {
